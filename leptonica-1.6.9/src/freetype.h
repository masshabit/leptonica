...
LEPT_DLL extern FT_LIBRARY *ftInitLibrary(void);

LEPT_DLL extern void ftShutdownLibrary(FT_LIBRARY  *lib_ptr);

LEPT_DLL extern PIX *pixWriteTTFText(FT_LIBRARY  *lib_ptr,
	PIX         *pixs,
	l_float32    size,
	l_float32    angle,
	l_int32      x,
